...
use sp_runtime::{
	traits::{self, Block as BlockT, Header as HeaderT, MaybeSerializeDeserialize, Member},
	Justifications,
};
use sp_std::prelude::*;
...
impl<Header, Extrinsic> BlockT for Block<Header, Extrinsic>
where
...
impl<Header, Extrinsic> ExtendedBlock for Block<Header, Extrinsic>
where
