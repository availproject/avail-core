...
pub struct ProofResponse {
    ...
    pub message: Option<AddressedMessageResponse>,
}

#[derive(Debug, Clone, Encode, Decode, PartialEq, Eq, TypeInfo)]
#[cfg_attr(feature = "serde", derive(Serialize, Deserialize))]
#[cfg_attr(feature = "serde", serde(rename_all = "camelCase"))]
pub struct AddressedMessageResponse {
...
pub fn new(message: AddressedMessage) -> AddressedMessageResponse {
    AddressedMessageResponse {
        message_type: message.message.r#type(),
        data: message.abi_data(),
        from: message.from,
        to: message.to,
